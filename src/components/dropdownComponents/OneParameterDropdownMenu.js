    ...
    render() {
        return <ButtonGroup>
            <Dropdown style={{ marginTop: '-7px' }}>
                ...
                <Dropdown.Menu>
                    {this.props.parameters.map((parameter, i) => { return <Dropdown.Item key={i} action="true" onClick={this.props.handleParameters.bind(this, parameter, 1, 1)}>{parameter}</Dropdown.Item> })}
                </Dropdown.Menu>
            </Dropdown> )
  </ButtonGroup>
    }
